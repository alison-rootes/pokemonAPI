...
function renderPokemon(pokeData){
    ...
    let pokeContainer = document.createElement("div") //div will be used to hold the details for pokemon.
    ...
    let pokeTypes = document.createElement('ul') //holds pokemon types
